package com.capgemini.Atividade52.view;
...
import com.capgemini.Atividade52.dao.CategoriaDao;
import com.capgemini.Atividade52.model.Categoria;
...
public class DesktopView extends JFrame{
    ...
    // ==================== Metodos de CRUD ===================================
    private void salvar(Categoria model) throws SQLException{
        dao.create(model);
